...
class SimilarQuestionAttachTest extends TestCase
{
    ...
    public function a_superadmin_can_attach_similar_questions()
    {
        ...
        $this->assertDatabaseHas((new SimilarQuestion)->getTable(), ['similar_question_id' => $data['similar_question']['id']]);
        $this->assertDatabaseHas((new SimilarQuestion)->getTable(), ['question_id' => $firstQuestion->id]);
    }
