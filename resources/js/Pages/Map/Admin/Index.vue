      ...
      <div class="bg-white shadow overflow-hidden sm:rounded-md">
          ...
          <div class="-ml-4 -mt-4 flex justify-between items-center flex-wrap sm:flex-no-wrap">
            ...
            <div class="ml-4 mt-4 flex-shrink-0">
              <span class="inline-flex rounded-md shadow-sm">
                <inertia-link :href="$route('admin.map.create')"
        ...
        <ul v-else>
          <li v-for="map in maps">
            <inertia-link :href="$route('admin.map.edit', {map_id: map.id})"
              ...
              <div class="flex items-center px-2 py-2 sm:px-6">
                <div class="min-w-0 flex-1 flex items-center">
                  ...
                  <div class="min-w-0 flex-1 px-4 md:grid md:grid-cols-2 md:gap-4">
                    <div>
                      <div class="text-sm leading-5 font-medium text-indigo-600 truncate">{{ map.name }}</div>
                      <div class="mt-2 flex items-center text-sm leading-5 text-gray-500">
                        <svg class="flex-shrink-0 h-3 w-3 text-gray-400" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <div class="hidden md:block">
                      <div>
                        ...
                        <div class="mt-2 flex items-center text-sm leading-5 text-gray-500">
                          <svg v-if="map.published" class="flex-shrink-0 mr-1.5 h-5 w-5 text-green-400" fill="currentColor"
                            viewBox="0 0 20 20">
                            <path fill-rule="evenodd"
                              d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z"
                              clip-rule="evenodd" />
                          </svg>
                          <svg v-else class="flex-shrink-0 mr-1.5 h-5 w-5 text-red-500"
                        ...
                        <div class="mt-2 flex items-center text-sm leading-5 text-gray-500">
                          <svg v-if="map.questionCount === 0" class="flex-shrink-0 mr-1.5 h-5 w-5 text-red-500"
                            fill="currentColor" viewBox="0 0 24 24">
                            <path class="heroicon-ui"
                              d="M4.93 19.07A10 10 0 1 1 19.07 4.93 10 10 0 0 1 4.93 19.07zm1.41-1.41A8 8 0 1 0 17.66 6.34 8 8 0 0 0 6.34 17.66zM13.41 12l1.42 1.41a1 1 0 1 1-1.42 1.42L12 13.4l-1.41 1.42a1 1 0 1 1-1.42-1.42L10.6 12l-1.42-1.41a1 1 0 1 1 1.42-1.42L12 10.6l1.41-1.42a1 1 0 1 1 1.42 1.42L13.4 12z" />
                          </svg>
                          <svg v-else class="flex-shrink-0 mr-1.5 h-5 w-5 text-green-400" fill="currentColor"
                            viewBox="0 0 20 20">
                            <path fill-rule="evenodd"
                              d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z"
                              clip-rule="evenodd" />
