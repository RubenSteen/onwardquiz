        ...
        <div v-show="sidebarOpen" x-transition:enter-start="-translate-x-full" x-transition:enter-end="translate-x-0" x-transition:leave-start="translate-x-0" x-transition:leave-end="-translate-x-full" class="flex-1 flex flex-col max-w-xs w-full bg-white transform ease-in-out duration-300 ">
          ...
          <div class="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
            ...
            <nav class="mt-5 px-2">
              ...
              <inertia-link v-if="$page.auth.user.isSuperAdmin" :href="$route('map.index')" v-bind:class="{ 'text-gray-900 bg-gray-100 hover:bg-gray-100 focus:bg-gray-200': currentActiveLink('admin.map.index') }" class="group flex items-center px-2 py-2 text-sm leading-5 font-medium text-gray-600 rounded-md hover:text-gray-900 hover:bg-gray-50 focus:outline-none focus:bg-gray-100 transition ease-in-out duration-150">
              ...
              <inertia-link v-if="$page.auth.user.isSuperAdmin" :href="$route('admin.user.index')" v-bind:class="{ 'text-gray-900 bg-gray-100 hover:bg-gray-100 focus:bg-gray-200': currentActiveLink('auth.admin.user.index') }" class="mt-1 group flex items-center px-2 py-2 text-sm leading-5 font-medium text-gray-600 rounded-md hover:text-gray-900 hover:bg-gray-50 focus:outline-none focus:bg-gray-100 transition ease-in-out duration-150">
              ...
              <inertia-link :href="$route('team.index')" class="mt-1 group flex items-center px-2 py-2 text-base leading-6 font-medium text-gray-600 rounded-md hover:text-gray-900 hover:bg-gray-50 focus:outline-none focus:text-gray-900 focus:bg-gray-100 transition ease-in-out duration-150">
