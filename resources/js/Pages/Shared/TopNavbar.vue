<template>
  <div class="flex items-center flex-row flex-wrap justify-between pr-4" style="font-size:.900rem;">

    <div class="">
      <inertia-link href="#" class="inline-block nav-item mr-4"><i class="fas fa-icons" /><span> Start quiz</span></inertia-link>
      <inertia-link href="#" class="inline-block nav-item mr-4"><i class="fas fa-icons" /><span> Clips</span></inertia-link>
    </div>
    ...
    <div class="flex items-center">
      ...
      <div v-else class="flex items-center">
        <inertia-link :href="loginURL" class="inline-block nav-item mr-4"><i class="fas fa-icons" /><span> Login</span></inertia-link></div>
    </div>
  ...
  export default {
    methods: {
      logout() {
        ...
        this.$inertia.post(route('logout.post'), data)
          .then(() => {
            // Do something
          })
      }, // End logout()
