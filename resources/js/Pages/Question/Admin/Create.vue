          ...
          <div class="mt-6 sm:mt-5">
            <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
              ...
              <div class="mt-1 sm:mt-0 sm:col-span-2">
                ...
                <p class="mt-2 text-xs text-red-600" v-show="$page.errors.callout" v-for="error in $page.errors.callout">
                  {{ error }}</p>
              </div>
            </div>
          </div>
      ...
      <div class="mt-8 border-t border-gray-200 pt-5">
        <div class="flex justify-end">
          ...
          <span class="ml-3 inline-flex rounded-md shadow-sm">
            <button :disabled="loading" @click="createQuestion" type="button" ref="submit"
  ...
  export default {
    ...
    methods: {
      createQuestion() {
        ...
        this.$inertia.post(route('admin.question.store', {map: this.map.id}), data)
          .then(() => {
            this.loading = false;
          })
      }, // End createQuestion()
