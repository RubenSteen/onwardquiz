    ...
    <div>
        ...
        <div>
            <ul class="mt-3 grid grid-rows-3 grid-flow-col gap-4">
                <li v-for="fakeAnswer in fakeAnswers" class="col-span-1 flex shadow-sm rounded-md">
                    <div
...
export default {
    ...
    methods: {
        submit() {
            ...
            this.$inertia
                .post(
                    route('question.store.fake-answer', {
                        map: this.mapId,
        ...
        reset() {
            ...
            // will only delete the error keys from fake-answer
